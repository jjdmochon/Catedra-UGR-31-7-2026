---
title: "Marco y Filosofía Docente Universitaria: Prof. Dr. Juan José Díaz-Mochón"
type: docencia
date_created: 2026-08-26
date_updated: 2026-09-06
status: active
confidence: high
tags: [docencia, pedagogia, ugr, farmacia, cta, nhd, transmed, docentia]
...
```mermaid
graph TD
    A["Docencia Universitaria · Prof. Juan José Díaz-Mochón"] --> B["Grado en Farmacia (Troncal)"]
    A --> C["Grado en Ciencia y Tecnología de Alimentos (CTA)"]
    A --> D["Grado en Nutrición Humana y Dietética (NHD)"]
    A --> E["Posgrado y Doctorado (Máster TRANSMED)"]
    
    B --> F["Química Orgánica 1 y 2"]
    B --> G["Química Farmacéutica 1 y 2"]
    C --> H["Química Orgánica y de Fármacos / Trazabilidad"]
    D --> I["Química General"]
    E --> J["Medicina Traslacional y Diagnóstico Molecular"]
```
